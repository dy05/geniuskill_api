                    ...
                    <div class="flex flex-col gap-3 mb-5">
                        ...
                        <div class="flex flex-row gap-2">
                            <div class="rounded h-96 w-96 relative" id="imageContainer">
                                <button type="button" class="bg-transparent block hidden border-none p-0 z-50 absolute right-2"
                                ...
                                <span class="bg-gray-300 w-full h-full block" style="background: url({{ asset('images/book.png') }}) no-repeat top; background-size: contain !important;"></span>
                            </div>
